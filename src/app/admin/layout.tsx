                ...
                {session && (
                    <aside className="w-64 bg-zinc-900 text-white flex flex-col fixed h-full z-50">
                        ...
                        <nav className="flex-1 p-4 space-y-2">
                            ...
                            <Link href="/admin/locations" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-zinc-800 transition-colors text-zinc-400 hover:text-white">
                                <MapPin size={20} />
                                <span className="font-bold">지점 관리</span>
                            </Link>
                        </nav>
                        <div className="p-4 border-t border-zinc-800 space-y-2">
                            <Link href="/" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-800 text-zinc-400 hover:text-white hover:bg-zinc-700 transition-all text-sm font-bold">
                                <span>🏠 홈페이지로 이동</span>
                            </Link>
                            <AdminLogoutBtn />
                        </div>
